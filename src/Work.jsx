...
export default function CustomizedDialogs() {
  ...
  return (
    <div>
      <Button variant="outlined" sx={{color:'white',fontSize:'large'}} onClick={handleClickOpen}>
      ...
      >
        ...
        <DialogContent dividers>
          ...
          <Typography gutterBottom>
            Created by : Siddhant Patil (Maulana Azad National Institute of Technology, Bhopal)
          </Typography>
          <Typography gutterBottom>
